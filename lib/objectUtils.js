...
async function position(gl, program, objRotationAngle, translateVector3, scaleVector3, canvas, eye, look, objRotationAfterTranslationAngle){
...
function getMovieScreenTexture(){
...
function setLighting(program, lighing1, lighing2, alpha, eye) {
    ...
    setVec3Uniform(program, lighing1.direction,'lightDirection');
    setVec3Uniform(program, lighing1.ambient.array(), 'ambiente');
    setVec3Uniform(program, lighing1.diffuse.array(), 'diffuse');
    setVec3Uniform(program, lighing1.specular.array(), 'specular');
    setVec3Uniform(program, eye,'eyeDir');
    setFloatUniform(program, alpha, 'alpha');

    if(lighing2 !== null){
        setVec3Uniform(program, lighing2.direction,'lightDirection2');
        setVec3Uniform(program, lighing2.ambient.array(), 'ambiente2');
        setVec3Uniform(program, lighing2.diffuse.array(), 'diffuse2');
        setVec3Uniform(program, lighing2.specular.array(), 'specular2');
    }
}
