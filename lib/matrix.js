...
function rotateX(out, input, rad) {
    ...
    out[2] = input[2];
    out[3] = input[3];
    out[4] = a4 * Math.cos(rad) + a8 * Math.sin(rad);
    out[5] = a5* Math.cos(rad) + a9 * Math.sin(rad);
    out[6] = a6* Math.cos(rad) + a10 * Math.sin(rad);
    out[7] = a7* Math.cos(rad) + a11 * Math.sin(rad);
    out[8] = a4 * -Math.sin(rad) + a8 * Math.cos(rad);
    out[9] = a5 * -Math.sin(rad) + a9 * Math.cos(rad);
    out[10] = a6 * -Math.sin(rad) + a10 * Math.cos(rad);
    out[11] = a7 * -Math.sin(rad) + a11 * Math.cos(rad);
    out[12] = input[12];
    out[13] = input[13];
    out[14] = input[14];
    out[15] = input[15];
...
function rotateZ(out, input, rad) {
    ...
    out[0] = a0 * Math.cos(rad) + a4 * Math.sin(rad);
    out[1] = a1 * Math.cos(rad) + a5 * Math.sin(rad);
    out[2] = a2 * Math.cos(rad) + a6 * Math.sin(rad);
    out[3] = a3 * Math.cos(rad) + a7 * Math.sin(rad);
    out[4] = a0 * -Math.sin(rad) + a4 * Math.cos(rad);
    out[5] = a1 * -Math.sin(rad) + a5 * Math.cos(rad);
    out[6] = a2 * -Math.sin(rad) + a6 * Math.cos(rad);
    out[7] = a3 * -Math.sin(rad) + a7 * Math.cos(rad);
    out[8] = input[8]
    out[9] = input[9];
    out[10] = input[10]
    out[11] = input[11]
...
function vec3MulMat3(out, vec, mat) {
    let o1, o2, o3

    o1 = vec[0] * mat[0] + vec[1] * mat[3] + vec[2] * mat[6]
    o2 = vec[0] * mat[1] + vec[1] * mat[4] + vec[2] * mat[7]
    o3 = vec[0] * mat[2] + vec[1] * mat[5] + vec[2] * mat[8]
